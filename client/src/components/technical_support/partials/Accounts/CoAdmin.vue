<template>
    <DataTable :value="computed_co_admin" paginator :rows="10" :rowsPerPageOptions="[10, 20,50]" stripedRows removableSort  showGridlines  >
        <template #header >
...
const computed_co_admin = computed(()=>{
    if(search.value != ''){
